...
# --------------------------------------------------------------------------
PIN_ITERATION_LABEL = "new-additions-through-resolve-input"
PIN_RECALL_TS = "2026-07-19T10:30:02Z"
...
# Zenodo concept DOI — resolves to the latest archived software version
# (per-version DOIs hang off it; v1.1.0 is 10.5281/zenodo.21441933).
SOFTWARE_DOI = "10.5281/zenodo.21441932"
...
def render_stats(data: dict) -> str:
    ...
    m(_macro("StatSoftwareDoi", SOFTWARE_DOI))
    m(f"\\urldef{{\\StatSoftwareDoiUrl}}\\url{{https://doi.org/{SOFTWARE_DOI}}}\n")
