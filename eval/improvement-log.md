...
## Iteration 114 — 2026-07-19T07:35:57Z — post-multifile-resolve
...
- `JSS-CITE-002`: tp +288→288 (+0), fp +29→29 (+0), pending 0→8 (+8)
- `JSS-CITE-003`: tp +268→268 (+0), fp +0→0 (+0), pending 0→3 (+3)
- `JSS-ABBR-001`: tp +20→20 (+0), fp +0→0 (+0), pending 0→20 (+20)
- `JSS-BIBTEX-003`: tp +62→62 (+0), fp +0→0 (+0), pending 0→1 (+1)
- `JSS-CAP-002`: tp +639→639 (+0), fp +11→11 (+0), pending 0→30 (+30)
- `JSS-CODE-001`: tp +450→450 (+0), fp +0→0 (+0), pending 0→13 (+13)
- `JSS-CODE-002`: tp +264→264 (+0), fp +0→0 (+0), pending 0→16 (+16)
- `JSS-CODE-003`: tp +2409→2409 (+0), fp +18→18 (+0), pending 0→36 (+36)
- `JSS-HOUSE-001`: tp +632→632 (+0), fp +0→0 (+0), pending 0→9 (+9)
- `JSS-HOUSE-002`: tp +36→36 (+0), fp +0→0 (+0), pending 0→1 (+1)
- `JSS-MARKUP-001`: tp +1152→1152 (+0), fp +185→185 (+0), pending 0→34 (+34)
- `JSS-MARKUP-003`: tp +1770→1770 (+0), fp +120→120 (+0), pending 0→1 (+1)
- `JSS-NAME-002`: tp +193→193 (+0), fp +0→0 (+0), pending 0→2 (+2)
- `JSS-OPER-003`: tp +440→440 (+0), fp +0→0 (+0), pending 0→1 (+1)
- `JSS-REFS-003`: tp +3556→3556 (+0), fp +137→137 (+0), pending 0→34 (+34)
- `JSS-REFS-004`: tp +651→651 (+0), fp +0→0 (+0), pending 0→37 (+37)
- `JSS-REFS-005`: tp +52→52 (+0), fp +0→0 (+0), pending 0→4 (+4)
- `JSS-REFS-006`: tp +1189→1189 (+0), fp +14→14 (+0), pending 0→25 (+25)
- `JSS-REFS-007`: tp +181→181 (+0), fp +0→0 (+0), pending 0→1 (+1)
- `JSS-STRUCT-002`: tp +33→33 (+0), fp +0→0 (+0), pending 0→3 (+3)
- `JSS-TYPO-001`: tp +266→266 (+0), fp +0→0 (+0), pending 0→1 (+1)
- `JSS-TYPO-004`: tp +72→72 (+0), fp +0→0 (+0), pending 0→4 (+4)
- `JSS-WIDTH-001`: tp +519→519 (+0), fp +0→0 (+0), pending 0→1 (+1)
- `JSS-XREF-004`: tp +1013→1013 (+0), fp +0→0 (+0), pending 0→8 (+8)
- `JSS-XREF-007`: tp +77→77 (+0), fp +0→0 (+0), pending 0→1 (+1)
...
violation recorded (0 tp, 0 fp, 0 pending) — no genuine `\input` cycle
...
reflects a rule regression — it's corpus-coverage growth, and needs an
`eval-review` pass before it means anything precision-wise.

### Plan

No further code changes from this iteration's own scope — this is a
...
pre-fix scan:
- unstripped TeX comments (`%\bibliography{bibliojss}` etc. — 3 hits,
...
- unbalanced-brace macro arguments (Sweave's
  `\bibliography{\Sexpr{Rcpp:::bib()}}` truncating at the first `}` —
...
- parent-relative instead of root-relative path resolution for nested
  ...
  document, not beside `technical.tex` — 4 hits).
...
this snapshot — they're currently unlabelled, so the full-corpus
precision percentages above are computed over a smaller reviewed
subset than the raw counts suggest.

### Results (post-implementation)

- `JSS-PROJECT-001`/`JSS-PROJECT-002`: 0 tp, 0 fp, 0 pending — no
...
- No existing rule's tp/fp changed. 294 new `pending` violations
  ...
  now reaches that weren't scanned before — needs `eval-review`, not a
  code change.
...
## Iteration 115 — 2026-07-19T08:39:56Z — new-additions-through-resolve-input
...
- `JSS-CITE-002`: tp +288→296 (+8), fp +29→29 (+0), pending 8→0 (-8)
- `JSS-CITE-003`: tp +268→271 (+3), fp +0→0 (+0), pending 3→0 (-3)
- `JSS-ABBR-001`: tp +20→40 (+20), fp +0→0 (+0), pending 20→0 (-20)
- `JSS-BIBTEX-003`: tp +62→63 (+1), fp +0→0 (+0), pending 1→0 (-1)
- `JSS-CAP-002`: tp +639→669 (+30), fp +11→11 (+0), pending 30→0 (-30)
- `JSS-CODE-001`: tp +450→463 (+13), fp +0→0 (+0), pending 13→0 (-13)
- `JSS-CODE-002`: tp +264→280 (+16), fp +0→0 (+0), pending 16→0 (-16)
- `JSS-CODE-003`: tp +2409→2442 (+33), fp +18→21 (+3), pending 36→0 (-36)
- `JSS-HOUSE-001`: tp +632→641 (+9), fp +0→0 (+0), pending 9→0 (-9)
- `JSS-HOUSE-002`: tp +36→37 (+1), fp +0→0 (+0), pending 1→0 (-1)
- `JSS-MARKUP-001`: tp +1152→1165 (+13), fp +185→206 (+21), pending 34→0 (-34)
- `JSS-MARKUP-003`: tp +1770→1771 (+1), fp +120→120 (+0), pending 1→0 (-1)
- `JSS-NAME-002`: tp +193→195 (+2), fp +0→0 (+0), pending 2→0 (-2)
- `JSS-OPER-003`: tp +440→441 (+1), fp +0→0 (+0), pending 1→0 (-1)
- `JSS-REFS-003`: tp +3556→3589 (+33), fp +137→138 (+1), pending 34→0 (-34)
- `JSS-REFS-004`: tp +651→688 (+37), fp +0→0 (+0), pending 37→0 (-37)
- `JSS-REFS-005`: tp +52→56 (+4), fp +0→0 (+0), pending 4→0 (-4)
- `JSS-REFS-006`: tp +1189→1214 (+25), fp +14→14 (+0), pending 25→0 (-25)
- `JSS-REFS-007`: tp +181→182 (+1), fp +0→0 (+0), pending 1→0 (-1)
- `JSS-STRUCT-002`: tp +33→36 (+3), fp +0→0 (+0), pending 3→0 (-3)
- `JSS-TYPO-001`: tp +266→267 (+1), fp +0→0 (+0), pending 1→0 (-1)
- `JSS-TYPO-004`: tp +72→76 (+4), fp +0→0 (+0), pending 4→0 (-4)
- `JSS-WIDTH-001`: tp +519→520 (+1), fp +0→0 (+0), pending 1→0 (-1)
- `JSS-XREF-004`: tp +1013→1021 (+8), fp +0→0 (+0), pending 8→0 (-8)
- `JSS-XREF-007`: tp +77→78 (+1), fp +0→0 (+0), pending 1→0 (-1)
...
auto-resolve started reaching for the first time — see iter 114). AI
...
pending** across the batch — 91.7% precision on newly-surfaced
findings, no rule regressions.

`JSS-MARKUP-001` absorbed most of the FPs (13 tp / 21 fp on this
batch), consistent with its existing `EXEMPT` status — not new, just
...
- **`JSS-CODE-003`** (2 FP): flags `=` inside Bash variable
  ...
  spacing as if it were R/`\code{}` operator spacing — Bash's
...
- **`JSS-MARKUP-001`** (2 of the 4 FP): flags tokens inside a
  ...
  programming-language names needing `\proglang{}` — the rule's
...
snippet, one custom verbatim alias) rather than systemic problems —
noted here for a future iteration, not actioned in this one.

`JSS-PROJECT-001`/`JSS-PROJECT-002` had nothing to adjudicate — still
zero firings anywhere in the corpus after the iter-114 fix.

### Plan

No code changes in this iteration — purely a review/adjudication pass
...
- `JSS-PROJECT-001`/`JSS-PROJECT-002`: still 0 tp / 0 fp / 0 pending —
...
## Iteration 116 — 2026-09-09T19:14:25Z — v1.2.0-release

- **Corpus size:** 255 papers
- **Tool version:** `1.0.1`
- **Parse failures:** full=26, pinned=16

**Note:** Release 1.2.0 (spec 027): version provenance, token-specific suggestions, baseline mode, fix receipts, recall+coverage reporting, colour, Overleaf zip. Detection unchanged from v1.0.1.
