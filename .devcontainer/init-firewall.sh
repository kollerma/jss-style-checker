...
# Allow traffic to host.docker.internal (192.168.65.254) for local LLM server
iptables -A INPUT -s 192.168.65.254 -j ACCEPT
iptables -A OUTPUT -d 192.168.65.254 -j ACCEPT
