...
**Schema version**: 1  
**Rule set**: 2026-09-07 (jss.cls 3.3, vendored 2021-05-23)  
**Rule-set fingerprint**: `sha256:e9715b94cfb8d199fcce76c4fb17862a35ebcae4ada77c41cd3db08267aceab5`  
...
| SG-043 | not checked | SHOULD (advisory): Set `options(prompt = "R> ", continue = "+  ", width = 70, useFancyQuotes = FALSE)` invisibly at the start of the vignette | — | implementable, not yet written: a rule needs the pre-transform chunk text, which the parser does not keep today (hidden chunks are blanked, line counts preserved). Carrying it is the same shape as ParsedTexFile.line_offset. The open question is severity — the guide marks this advisory |
